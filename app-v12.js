(function () {
  ...
  async function init() {
    ...
    try {
      ...
      showFatal(error, accessToken ? 'This private group link could not be authorized. Publish the v12 Firestore rules, then regenerate and resend the group links.' : 'Firebase could not load your tournaments. Check Firestore Database and Security Rules.');
    }
  }
